---
name: taste
description: Anti-slop frontend design taste skill. Use when a UI needs real design direction - landing pages, portfolios, product surfaces, and redesigns that should look intentional and modern rather than templated. Reads the brief, picks a design language, and enforces a strict pre-flight quality check.
user-invocable: true
---
