...
**Acceptance:** `transferctl config validate ./data/products/` catches every error class in [13](13-cli.md) §9. Coordinator starts against SQLite with no setup. Two Coordinators elect one leader. `task test` passes without Docker.
