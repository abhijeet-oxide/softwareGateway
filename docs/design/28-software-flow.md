...
**Answers:** the reference flow for automated ingestion, onboarding and promotion, plus the review that followed it.

The goal of this round is **not** the flow. It is the configuration. The flow in
That flow is one among many, and the test of this design is
